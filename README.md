...
This plugin grows out of the maintainer's original Personal Board of Directors concept — a five-persona advisory prompt with follow-up questions and a session template that predates this repo. The dossier structure, designated-dissenter seating, disagreement map, and grounding rules adapt patterns from `coreyhaines31/marketingskills`'s marketing-council skill, credited here with thanks. Seat charters, decision rights, blind spots, and the posture/hostility model draw on broader multi-agent-council research and a 2026-07 deep-research pass on the space. The dissent mechanism's lineage runs through the IDF's *Ipcha Mistabra* doctrine and its "10th man" popularization via *World War Z*.

<p align="center">
  <img src="https://contrib.rocks/image?repo=rubicon/rubicon-marketing-board" alt="Contributors">
</p>
